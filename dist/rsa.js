...
export async function main() {
    ...
    btns.sign.onclick = async () => {
        ...
        console.time("sign");
        try {
            const sig = await cryptos.signStringToBase64(inputmsg.value, parsedKeysa.d, parsedKeysa.p, parsedKeysa.q, parsedKeysa.n, parsedKeysa.dp, parsedKeysa.dq, parsedKeysa.qInv, parsedKeysa.muP, parsedKeysa.muQ, parsedKeysa.pShift, parsedKeysa.qShift);
    ...
    btns.verify.onclick = async () => {
        ...
        console.time("verify");
        try {
            const ok = await cryptos.verifyBase64Signature(inputmsg.value, sig, parsedPubKeys.e, parsedPubKeys.n, parsedPubKeys.muN, parsedPubKeys.nShift);
    ...
    btns.enc.onclick = async () => {
        ...
        try {
            const enc = await cryptos.encryptStringToBase64(inputmsg.value, parsedPubKeys.e, parsedPubKeys.n, parsedPubKeys.muN, parsedPubKeys.nShift);
    ...
    btns.dec.onclick = async () => {
        ...
        try {
            const dec = await cryptos.decryptBase64ToString(inputmsg.value, parsedKeysa.d, parsedKeysa.p, parsedKeysa.q, parsedKeysa.n, parsedKeysa.dp, parsedKeysa.dq, parsedKeysa.qInv, parsedKeysa.muP, parsedKeysa.muQ, parsedKeysa.muN, parsedKeysa.pShift, parsedKeysa.qShift, parsedKeysa.nShift);
