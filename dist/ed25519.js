...
export async function main() {
    ...
    function createButton(text, bgColor, textColor = "#333") {
    ...
    verifyBtn.onclick = async () => {
        ...
        try {
            ...
            resultArea.textContent = isValid
                ...
                : "❌ 検証に失敗しました。不正な署名です。";
            showToast(isValid ? "検証に成功しました" : "検証に失敗しました", isValid ? "success" : "error");
        }
        catch (e) {
    ...
    [hexToPrivPemBtn, hexToPubPemBtn, privPemToHexBtn, pubPemToHexBtn].forEach((b) => utilBtnGrid.appendChild(b));
