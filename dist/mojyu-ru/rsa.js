    ...
    async decryptSequential(chunks, d, p, q, n, nByteLen, onProgress, dp, dq, qInv) {
        ...
        for (let i = 0; i < chunks.length; i++) {
            ...
            try {
                ...
                throw new Error(`復号エラー: ブロック${i}のパディング検証に失敗しました`);
            }
